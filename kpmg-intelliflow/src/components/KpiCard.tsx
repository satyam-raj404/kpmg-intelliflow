      ...
      >
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="text-[12px] font-medium text-muted-foreground tracking-wide uppercase truncate">
              {label}
            </div>
          </div>
        ...
        <div className="mt-2.5 flex items-baseline gap-2">
          ...
          {delta && (
            <motion.span
              ...
              className={cn("inline-flex items-center gap-0.5 text-[12px] font-medium",
        ...
        {sublabel && (
          <div className="text-[12px] text-muted-foreground mt-1 leading-relaxed">{sublabel}</div>
        )}
        ...
        {threshold && (
          <motion.span
            ...
            className={cn("mt-2 inline-flex items-center self-start px-1.5 py-0.5 rounded text-[11px] font-medium", toneClasses[threshold.tone])}
          >
            {threshold.label}
          </motion.span>
        )}
