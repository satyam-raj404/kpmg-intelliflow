    ...
    >
      <div className="flex-1 max-w-lg relative">
        ...
        <input
          type="text"
          placeholder="Search..."
          className="w-full h-8 pl-8 pr-12 rounded-md border border-border bg-background text-[13px] placeholder:text-muted-foreground/50 focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/10 transition-all duration-200"
        />
      ...
      <DropdownMenu>
        <DropdownMenuTrigger className="h-8 px-2.5 rounded-md border border-border bg-background text-[12px] flex items-center gap-1.5 hover:border-accent/40 hover:bg-secondary/50 transition-all duration-200">
              ...
              >
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[10px] text-muted-foreground/50 mt-0.5">{n.time}</div>
                  </div>
                </div>
              </motion.div>
            ))}
